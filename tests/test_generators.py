...
def test_transaction_descriptions():  # type: ignore
    generator_transaction = transaction_descriptions(example_transactions)
    assert next(generator_transaction) == example_transactions[0]["description"]
    assert next(generator_transaction) == example_transactions[1]["description"]
